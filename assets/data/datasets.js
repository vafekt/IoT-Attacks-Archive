const DATASETS = [
  { id:1, name:"CIC IoT 2023", year:2023, format:"PCAP, CSV", protocols:["Wi-Fi","Zigbee","Z-Wave","TCP","UDP","ICMP","HTTP","SSH"], attacks:33, benign:"Yes", testbed:"Physical", institution:"Canadian Institute for Cybersecurity",
  ...
  { id:2, name:"CIC IIoT 2025 (DataSense)", year:2025, format:"PCAP, CSV", protocols:["MQTT","Wi-Fi","TCP","UDP","HTTP","HTTPS","SSH","Telnet"], attacks:50, benign:"Yes", testbed:"Physical", institution:"Canadian Institute for Cybersecurity",
  ...
  { id:3, name:"CIC IoMT 2024", year:2024, format:"PCAP, CSV", protocols:["Wi-Fi","MQTT","BLE","TCP","UDP","ICMP","HTTP","DNS","SSH","ARP"], attacks:18, benign:"Yes", testbed:"Hybrid", institution:"Canadian Institute for Cybersecurity",
  ...
  { id:8, name:"CIC Modbus Dataset 2023", year:2023, format:"PCAP, CSV", protocols:["Modbus TCP/IP"], attacks:9, benign:"Yes", testbed:"Simulated (Docker)", institution:"Canadian Institute for Cybersecurity",
